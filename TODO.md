...
- [~] manca da controllare la lingua inglese — AppLocalizations esteso con +155 chiavi totali. View completamente localizzate IT↔EN: MyDayView, workout templates UI, bulk actions, load-more virtualization, export PDF, change_password_screen, diet_templates_view, audit_log_view, matchmaking_board_view, nutritional_calculator_view, gdpr_privacy_view, _UserDetailPane, dashboard nav. Ancora hardcoded: chat_management_view, reports_view, analytics_view, server_metrics_view, rewards_catalog_view, config_view, two_factor_setup_screen, workout_management_view, parts of user_management_view.
